...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-30 h-full w-64 bg-slate-900 border-r border-slate-800 transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-white">Queue Manager</h1>
              <p className="text-xs text-slate-500">RustPress Plugin</p>
            </div>
          </div>
          <button
            onClick={toggleSidebar}
        ...
        <nav className="p-4 space-y-6 overflow-y-auto h-[calc(100vh-4rem)]">
          ...
          <NavSection title="Configuration" items={settings} />
          ...
          <div className="pt-4 border-t border-slate-800">
            <div className="px-4 py-3 bg-slate-800/50 rounded-lg">
              ...
              <p className="text-xs text-slate-500 mt-1">Last checked: just now</p>
            </div>
          </div>
        </nav>
      </aside>
